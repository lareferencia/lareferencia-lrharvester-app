...
angular.module('network.json.schemas', []).service('JSONNetworkSchemas',  function() {
	...
	this.network_schema = {
	    type: "object",
	    properties: {
		  acronym : { type: "string", minLength: 2, maxLength: 10, title: "Repository Acronym", description: "Acrónimo identificatorio del repositorio (debe ser único)", required: true },
	      name: { type: "string", minLength: 2, title: "Repository Name", description: "Nombre de repositorio", required: true },
	      institutionAcronym: { type: "string", minLength: 2, title: "Institution Acronym", description: "Acrónimo de la Institución", required: true},
	      institutionName: { type: "string", minLength: 2, title: "Institution", description: "Nombre Institución", required: true},
	      published :{ type: "boolean", title: "public visible?", description: "La red es visible al público" },
	      scheduleCronExpression : { type: "string", title: "Schedule tasks expresion", description: "Expresión cron para programar la cosecha", "default": "* 0 0 29 2 *" }, 
